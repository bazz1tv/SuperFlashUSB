...
prog: pc/main.cpp main.h common.h pc/graphics.o pc/USB.o pc/menu.o pc/sflash/id.o pc/sflash/read.o pc/sflash/util.o pc/sflash/erase.o pc/sflash/write.o pc/sflash/unlock_blocks.o
	g++ -o prog -L/usr/local/lib  -I/usr/local/include/libusb-1.0 pc/main.cpp pc/graphics.o pc/USB.o pc/menu.o pc/sflash/read.o pc/sflash/id.o pc/sflash/util.o pc/sflash/erase.o pc/sflash/write.o pc/sflash/unlock_blocks.o -lusb-1.0 

pc/sflash/util.o: pc/sflash/util.h pc/sflash/util.cpp
	g++ -c -o pc/sflash/util.o -I/usr/local/include/libusb-1.0 pc/sflash/util.cpp

pc/graphics.o: pc/graphics.cpp pc/graphics.h common.h main.h
	g++ -c -o pc/graphics.o  -I/usr/local/include/libusb-1.0 pc/graphics.cpp
pc/USB.o: pc/USB.h pc/USB.cpp common.h main.h
	g++ -c -o pc/USB.o -I/usr/local/include/libusb-1.0 pc/USB.cpp
pc/menu.o: pc/menu.h pc/menu.cpp common.h main.h
	g++ -c -o pc/menu.o -I/usr/local/include/libusb-1.0 pc/menu.cpp
#sflash.o: pc/sflash.cpp pc/sflash.h common.h main.h
#	g++ -c -o pc/sflash.o -I.. -I/usr/local/include/libusb-1.0 pc/sflash.cpp

pc/sflash/id.o: pc/sflash/id.h pc/sflash/id.cpp main.h
	g++ -c -o pc/sflash/id.o -I/usr/local/include/libusb-1.0 pc/sflash/id.cpp
pc/sflash/read.o: pc/sflash/read.h pc/sflash/read.cpp main.h 
	g++ -c -o pc/sflash/read.o -I/usr/local/include/libusb-1.0 pc/sflash/read.cpp
	
pc/sflash/erase.o: pc/sflash/erase.h pc/sflash/erase.cpp main.h 
	g++ -c -o pc/sflash/erase.o -I/usr/local/include/libusb-1.0 pc/sflash/erase.cpp
	
pc/sflash/write.o: pc/sflash/write.h pc/sflash/write.cpp main.h 
	g++ -c -o pc/sflash/write.o -I/usr/local/include/libusb-1.0 pc/sflash/write.cpp
	
pc/sflash/unlock_blocks.o: pc/sflash/unlock_blocks.h pc/sflash/unlock_blocks.cpp main.h 
	g++ -c -o pc/sflash/unlock_blocks.o -I/usr/local/include/libusb-1.0 pc/sflash/unlock_blocks.cpp
